...
export function MobileMarkup({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-[#0b0b0b] text-white md:hidden">
          ...
          {asset.callouts.map((callout, index) => {
            ...
            return (
              <button
                ...
                className={`absolute flex h-9 w-9 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full text-sm font-black text-black shadow-md ${
                  isSelected ? "bg-white scale-125" : "bg-orange-400"
                }`}
                style={{
                  left: `${callout.x}%`,
                  top: `${callout.y}%`,
      ...
      <div className="border-t border-white/10 bg-[#141212] p-4">
        {selectedCallout ? (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full rounded-full bg-orange-400 py-4 font-black uppercase italic text-black"
            >
              Save Note
            </button>
          </div>
          ...
          <p className="text-center text-sm font-bold text-white/50">
            Tap the image to place a callout.
          </p>
        )}
      </div>
    </div>
