...
if (newAssetIds.length > 0) {
  ...
  return (
    <div className="space-y-5 p-5">
      ...
      <label className="flex min-h-44 cursor-pointer flex-col items-center justify-center rounded-3xl border-2 border-dashed border-[#f9a331] bg-zinc-200 p-6 text-center shadow-sm">
